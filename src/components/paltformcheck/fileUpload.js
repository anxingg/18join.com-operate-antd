...
class UploadFile extends React.Component {
  ...
  handleChange = (info) => {
    if (info.file.status === 'done') {
      ...
      this.props.setCreditFile(info.file.response.message.newPath);
    }
  }
  ...
  render() {
    ...
    return (
      <Upload
        ...
        action={`/api/operate/uploadFile?format=json&busiDir=SL_LoanCreditReportFileDir&fileType=SUPPLY_CREDIT_INFO&fileOwnerId=${joinuserid}`}
